...
| **Tools** | T1 | Fix real a11y issues; re-run axe (or equiv.); no rule-disable to clear the board |
...
- `@ts-ignore`, blanket `any`, a11y rule disable, or delete tests/features to clear a scoreboard  
